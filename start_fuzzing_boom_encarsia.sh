...
make SIM_BUILD=build_boom_batch${BATCHNO} VFILE=SmallBoomTile_encarsia TOPLEVEL=BoomTile NUM_ITER=${ITERS} OUT=batch${BATCHNO} ALL_CSR=${ALL_CSR} FP_CSR=${FP_CSR} |& tee run.${BATCHNO}.boom.log
