...
def save_mismatch(base, proc_num, out, sim_input: simInput, data: list, num, it): #, elf, asm, hexfile, mNum):
    ...
    elf = base + '/tests/.input_{}{}.elf'.format(it, sim_input.name_suffix)
    asm = base + '/tests/.input_{}{}.S'.format(it, sim_input.name_suffix)
    hexfile = base + '/tests/.input_{}{}.hex'.format(it, sim_input.name_suffix)
