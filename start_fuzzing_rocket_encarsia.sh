...
export SPIKE="/local/home/mboelcskei/encarsia/encarsia-processorfuzz/new_spike"
...
make SIM_BUILD=build_rocket_batch${BATCHNO} VFILE=RocketTile_encarsia TOPLEVEL=RocketTile NUM_ITER=${ITERS} OUT=batch${BATCHNO} ALL_CSR=${ALL_CSR} FP_CSR=${FP_CSR} |& tee run.${BATCHNO}.rocket.log
